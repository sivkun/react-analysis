...
function getRenderedHostOrTextFromComponent(component) {
  var rendered;
/*
MyComponent1：render(){return({this.props.children})}
MyComponent2：render(){return({this.props.children})}
MyComponent3：render(){return(<div>{this.props.children}</div>)}
...
<div>hello</div>
 ...
 这里返回的结果就是这个ReactELement
*/
//我的理解是：自定义组件嵌套的情况只需要取出最内层组件的render后的ReactElement对象（Host{native DOM}或者text）
