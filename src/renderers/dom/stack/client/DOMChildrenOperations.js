...
function getNodeAfter(parentNode, node) {
  ...
  return node ? node.nextSibling : parentNode.firstChild;//有可能返回空，node.nextSibling==null
}
...
var insertChildAt = createMicrosoftUnsafeLocalFunction(
  function(parentNode, childNode, referenceNode) {
    ...
    // we are careful to use `null`.)//insertBefore(node, null)和appendChild(node)等价
